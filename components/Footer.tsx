...
export default function Footer() {
  ...
  return (
    <footer className="py-8 bg-[#0a0a0a] border-t border-white/10 text-center">
        ...
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="flex space-x-6">
            <a 
              ...
              aria-label="GitHub"
            >
              <svg className="w-6 h-6 text-[#171515] group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0-0-24-24" aria-hidden="true">
          ...
          <div className="text-gray-500 font-mono text-sm pt-4 border-t border-white/5 w-full text-center">
            <p className="mb-2 tracking-wide">Built by Atif Shaikh</p>
